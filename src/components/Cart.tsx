              ...
              {step === 'success' ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="px-8 py-3 bg-primary text-primary-foreground font-paragraph text-sm uppercase tracking-widest hover:bg-primary/90 transition-colors"
                  >
              ...
              <div className="border-t border-primary/10 p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-primary text-primary-foreground font-paragraph text-sm hover:bg-primary/90 transition-colors"
                      >
                ...
                {step === 'cart' ? (
                  <button
                    ...
                    className="w-full py-4 bg-primary text-primary-foreground font-paragraph text-sm uppercase tracking-widest font-semibold hover:bg-primary/90 transition-colors"
                  >
                    {getTranslation('cart.checkout', language, props)}
                  </button>
                ) : (
                  <button
                    ...
                    className="w-full py-4 bg-primary text-primary-foreground font-paragraph text-sm uppercase tracking-widest font-semibold hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
